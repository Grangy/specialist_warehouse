                    ...
                    >
                      ...
                      <div className="space-y-4 max-h-[70vh] overflow-y-auto">
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-gradient-to-r from-yellow-500/20 to-amber-500/20 hover:from-yellow-500/30 hover:to-amber-500/30 border border-yellow-500/40 hover:border-yellow-500/60 text-yellow-400 hover:text-yellow-300 transition-all duration-200"
                          title="Общий топ"
                        >
