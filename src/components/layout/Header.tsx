                        ...
                        <div className="bg-slate-900/80 rounded-lg p-3 border border-slate-700/50">
                          ...
                          {rankingStats?.daily ? (
                            <div className="space-y-2 text-xs">
                              ...
                              {(() => {
                                const dp = (rankingStats.daily as { dictatorPoints?: number } | undefined)?.dictatorPoints;
                                return dp != null && dp > 0 ? (
                        ...
                        <div className="bg-slate-900/80 rounded-lg p-3 border border-slate-700/50">
                          ...
                          {rankingStats?.monthly ? (
                            <div className="space-y-2 text-xs">
                              ...
                              {(() => {
                                const mp = (rankingStats.monthly as { dictatorPoints?: number } | undefined)?.dictatorPoints;
                                return mp != null && mp > 0 ? (
                                  <div className="flex items-center justify-between py-1 text-amber-400/90">
                                    <div className="flex items-center gap-2 text-slate-400">
                                      <span className="text-[10px]">Диктовщик:</span>
