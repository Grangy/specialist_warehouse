...
export function Tabs({ currentTab, newCount, onHandsCount, pendingCount, waitingCount, onTabChange, userRole }: TabsProps) {
  ...
  const canAccessOnHands = userRole === 'admin' || userRole === 'checker' || userRole === 'warehouse_3';
