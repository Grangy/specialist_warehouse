        ...
        <div className="p-5 overflow-y-auto space-y-6 text-slate-300 text-sm">
          ...
          <section>
            ...
            <div className="bg-slate-800/70 rounded-lg p-4 space-y-3 font-mono text-xs">
              ...
              <p className="text-slate-500 mt-1">Вес = (сборка + проверка + диктовка + доп.работа) с начала месяца ÷ эталон (Эрнес=100%), не ниже 30%. 09:00–09:15 МСК: фикс. ставка.</p>
              <p><strong className="text-slate-400">За ошибки</strong></p>
              <p>Ошибка сборки: сборщик −1 балл за каждую ошибку. Ошибка проверки (фиксирует админ): проверяльщик −5, админ +6.</p>
            </div>
