        ...
        <div className="p-5 overflow-y-auto space-y-6 text-slate-300 text-sm">
          ...
          <section>
            ...
            <div className="bg-slate-800/70 rounded-lg p-4 space-y-3 font-mono text-xs">
              ...
              <p>Баллы/мин = (темп склада за 15 мин ÷ 15 ÷ активные) × полезность</p>
              <p className="text-slate-500 mt-1">Темп = сумма orderPoints за 15 мин. Полезность = (сборка + проверка + диктовка + доп.работа) с начала месяца ÷ баллы эталона (Эрнес=100%). 09:00–09:15 МСК: фикс. ставка.</p>
