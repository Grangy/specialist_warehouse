        ...
        <div className="p-5 overflow-y-auto space-y-6 text-slate-300 text-sm">
          ...
          <section>
            <h3 className="flex items-center gap-2 font-semibold text-slate-100 mb-2">
              ...
              Как считаются баллы (только позиции)
            </h3>
            <p className="mb-3 text-slate-400">
              Баллы начисляются только за количество позиций. Скорость работы не влияет.
            </p>
            <div className="bg-slate-800/70 rounded-lg p-4 space-y-3 font-mono text-xs">
              <p><strong className="text-amber-400/90">Сборка</strong></p>
              <p>Склад 1: 1 балл за позицию · Склад 2/3: 2 балла за позицию</p>
              <p><strong className="text-amber-400/90">Проверка самостоятельно</strong></p>
              <p>Склад 1: 0,78 балла за позицию · Склад 2/3: 1,34 балла за позицию</p>
              <p><strong className="text-amber-400/90">Проверка с диктовщиком</strong></p>
              <p>Склад 1: проверяльщик 0,39 · диктовщик 0,36 за позицию</p>
              <p>Склад 2/3: проверяльщик 0,67 · диктовщик 0,61 за позицию</p>
              <p><strong className="text-amber-500/90">Доп. работа</strong></p>
              <p>Темп за мин = сумма баллов за 15 мин ÷ 15. Доля сотрудника = темп × (вес ÷ сумма весов активных за эти 15 мин).</p>
              <p className="text-slate-500 mt-1">Вес доп.работы: max(50%, √(продуктивность/топ месяца)), в окне 15 мин разброс не больше 1.6×. 09:00–09:15 МСК: фикс. ставка.</p>
              <p><strong className="text-slate-400">За ошибки</strong></p>
              <p>Ошибка сборки (проверяльщик): сборщик −1 / проверяльщик +1 (новенький); сборщик −5 / проверяльщик +5 (остальные).</p>
              <p>Ошибка проверки (админ): сборщик −1/−5, проверяльщик −10, админ +11 (новенький) / +15 (остальные).</p>
            </div>
            <p className="mt-2 text-slate-400">
              Итог: чем больше позиций обработано — тем больше баллов. Баллы за доп. работу добавляются отдельно.
            </p>
          </section>
          ...
          <section className="pb-2">
            <p className="text-amber-400/90 font-medium">
              Итог: баллы зависят только от количества позиций и склада.
            </p>
          </section>
        </div>
      </div>
