export function sanitizeShipmentComment(
  ...
  const patterns: RegExp[] = [
    ...
    // Варианты, которые реально приходят из 1С/сайта:
    // "Комментарий менеджера на сайте: оплата безнал|Способ оплаты:Безналичный"
    // "Комментарий менеджера на сайте: оплата безнал|Способ оплаты:Наличные"
    /Комментарий\s*менеджера(?:\s+на\s+сайте)?\s*:?\s*оплата\s*безнал\s*\|\s*Способ\s*оплаты\s*:?\s*Безналичный/gi,
    /Комментарий\s*менеджера(?:\s+на\s+сайте)?\s*:?\s*оплата\s*безнал\s*\|\s*Способ\s*оплаты\s*:?\s*Наличные/gi,
  ];
